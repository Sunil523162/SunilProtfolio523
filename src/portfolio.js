...
const experience = {
  ...
  description:
    "I have some work experience in college Project's. I got basic knowledge from doing projects. I had done my project in HTML ,CSS,PHP, JavaScript, laravelPHP ,React js ,Node js etc.",
  header_image_path: "experience.svg",
  sections: [
    {
      title: "Work in Programming Language",
      experiences: [
        {
          title: "HTML",
